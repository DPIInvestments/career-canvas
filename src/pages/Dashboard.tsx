...
export default function Dashboard() {
  ...
  return (
    <div className="container max-w-3xl py-12">
      ...
      <h2 className="mb-4 text-lg font-bold text-foreground">{t('dash.actions', language)}</h2>
      <div className="grid gap-3 sm:grid-cols-3">
        <Button asChild variant="outline" className="h-auto flex-col gap-2 rounded-2xl py-6">
          <Link to="/preview">
